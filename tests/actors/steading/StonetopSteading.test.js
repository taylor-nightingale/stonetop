...
describe("StonetopSteading.buildSnapshot", () => {
	...
	// Decoration under the Resources list, and only in a world that installed it — the default fake
	// art store has nothing, which is the world of anyone who has never run the installer.

// View-model for the NPC sheet: a flat, render-ready snapshot of the NPC stat block.
// Selection fields (tags, instinct) become queryable Selection instances so the chips /
// combobox partials can render them. The *Html fields are filled in by StonetopNpc.buildSnapshot
// after enrichment. Ported/adapted from taylor-nightingale/stonetop.
...
export class NpcSnapshot {
	constructor(b) {
		...
		this.instinctSelection = Selection.fromStored(b._instinct, { multi: false });

...
// and instinct / cost (single-select). Queryable (e.g. tags.has("group")) and consistent across
// playbook, follower, NPC, and companion. Ported from taylor-nightingale/stonetop for the NPC
// actor subsystem. Immutable: toggle() returns a new Selection.
export class Selection {
	 ...
	 * the structured object, and an existing Selection.
	 */

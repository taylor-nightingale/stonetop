...
// Book II wonder improvements get their own pack (owned + regenerated by build-improvements.js); the
// hand-authored Stonetop-core improvements stay in `steading-improvements`.
export const IMPROVEMENTS_PACK = "wonder-improvements";
